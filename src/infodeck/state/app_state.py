...
class InfodeckUiState:
    ...
    _conv_sessions_dir: str = field(default="", repr=False, compare=False)
    _conv_expanded: dict = field(default_factory=dict, repr=False, compare=False)
    ...
    _mem_user_container: object = field(default=None, repr=False, compare=False)
    _mem_memory_container: object = field(default=None, repr=False, compare=False)
    _mem_soul_container: object = field(default=None, repr=False, compare=False)
    _mem_editor_container: object = field(default=None, repr=False, compare=False)
    _mem_textarea: object = field(default=None, repr=False, compare=False)
    _memory_files: object = field(default=None, repr=False, compare=False)
    _memory_selected: object = field(default=None, repr=False, compare=False)
    _memory_dirty: bool = field(default=False, repr=False, compare=False)
